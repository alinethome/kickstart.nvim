...
-- Keybinds to make navigating wrapped text easier
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- vim.keymap.set('n', '<C-p>', '<leader>sf', { desc = 'Search workspace files' })
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- Enable roc lsp and set up capabilities
      local roc_setup = { capabilities }
      local lspconfig = require 'lspconfig'
      lspconfig.roc_ls.setup(roc_setup)
